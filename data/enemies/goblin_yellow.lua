-- Lua script of enemy goblin_yellow.
...
function enemy:set_weapon(weapon_name)
  ...
  if weapon ~= "slingshot" then
    sprite = self:create_sprite("enemies/goblin_yellow")
  end
  ...
  elseif weapon_name == "slingshot" then
    -- Replace main sprite.
    has_weapon, has_throwable_weapon = true, true
    sprite = self:create_sprite("enemies/goblin_yellow_slingshot")    
  end
...
function enemy:throw()
  ...
  if weapon_name == "axe" then
    ...
    speed = speed_axe
  elseif weapon_name == "slingshot" then
    proj_sprite_id = "enemies/goblin_yellow_slingshot"
